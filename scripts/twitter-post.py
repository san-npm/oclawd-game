#!/usr/bin/env python3
"""Post a tweet. Usage: python3 twitter-post.py <text>"""
...
if not text:
    print("Usage: python3 twitter-post.py <text>")
    sys.exit(1)

result = oauth_req("POST", "https://api.twitter.com/2/tweets", json.dumps({"text": text}).encode())
