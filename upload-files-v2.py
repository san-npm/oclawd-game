...
NOTION_VERSION = "2024-02-06"  # Different version!
...
def create_block(content, block_type="paragraph"):
    ...
    if block_type == "paragraph":
        ...
        # Different format for divider in older API
        return {
            "object": "block",
            "type": "divider"
        }
...
print("🦀 Clawdberg Notion Uploader (v2)")
...
for file in files:
    ...
    for i in range(0, len(lines), 100):
        ...
        if result.stdout == "OK":
            ...
            print(f"   Chunk {i//100 + 1}: {len(blocks)} blocks - {result.stdout[:80]}")
